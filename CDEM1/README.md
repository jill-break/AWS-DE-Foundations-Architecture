...
- **VPC Configuration**: Architecting `data-platform-vpc` (10.0.0.0/16) securely segmented into distinct public and private subnets across multiple Availability Zones to ensure high availability and robust security.
- **Subnet Layering**: 
